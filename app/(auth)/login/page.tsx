  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-1">
        ...
        <p className="text-sm text-gray-500">Sign in to your LinkNG account</p>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors"
      >
        <GoogleIcon />
